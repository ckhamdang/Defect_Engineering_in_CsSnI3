...
krreg_opt.fit(X_train, E_form_train)
print('Best estimator by RandomizedSearchCV:', krreg_opt.best_estimator_)

Pred_train = krreg_opt.predict(X_train)
Pred_test  = krreg_opt.predict(X_test)

result = permutation_importance(krreg_opt, X_train, E_form_train, n_repeats=10, random_state=42)
